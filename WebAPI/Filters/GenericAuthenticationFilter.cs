...
namespace WebAPI.Filters
{
    ...
    public class GenericAuthenticationFilter : AuthorizationFilterAttribute
    {
        ...
        /// <param name="filterContext"></param>  
        /// <returns></returns>  
        protected virtual bool OnAuthorizeUser(string username, string word, HttpActionContext actionContext)
        {
            if (string.IsNullOrEmpty(username) || string.IsNullOrEmpty(word)) return false;
            return true;
        }
